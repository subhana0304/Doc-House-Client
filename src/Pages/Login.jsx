    ...
    return (
        ...
        <div className='flex justify-center items-center mx-auto py-10'>
            <div className='border p-10 rounded'>
                <h3 className='font-bold text-xl text-center mb-2'>Sign In to Doc House</h3>
                ...
                <input className='btn bg-[#F7A582] border-[#F7A582] w-full text-white hover:bg-[#faa27c] hover:border-[#F7A582] my-2' type="submit" value="Sign In" />
                <p>Don't have an Account? <Link className='text-[#F7A582]' to='/signUp'>Sign Up</Link></p>
                </form>
            </div>
        </div>
    </div>
